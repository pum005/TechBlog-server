package com.toy.techblog.util.OAuthAPI.service;

import com.toy.techblog.domain.user.entity.User;
import com.toy.techblog.domain.user.repository.UserRepository;
import com.toy.techblog.util.OAuthAPI.other.KakaoUserInfo;
import com.toy.techblog.util.OAuthAPI.other.NaverUserInfo;
import com.toy.techblog.util.OAuthAPI.other.OAuth2UserInfo;
import com.toy.techblog.util.OAuthAPI.other.PrincipalDetails;
